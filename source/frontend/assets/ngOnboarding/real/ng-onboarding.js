  ...
  app.provider("ngOnboardingDefaults", function() {
    return {
      options: {
        ...
        titleClass: 'onboarding-popover-title yellowBarModel whiteColor',
        contentClass: 'onboarding-popover-content',
        arrowClass: 'onboarding-arrow',
        buttonContainerClass: 'onboarding-button-container',
        buttonClass: "onboarding-button yellowBarModel whiteColor",
        showButtons: true,
        nextButtonText: 'Siguiente &rarr;',
        previousButtonText: '&larr; Anterior',
        showDoneButton: true,
        doneButtonText: 'Aceptar',
        closeButtonClass: 'onboarding-close-button whiteColor',
        closeButtonText: 'X',
