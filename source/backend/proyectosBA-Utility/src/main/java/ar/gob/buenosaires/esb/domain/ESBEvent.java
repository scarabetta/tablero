...
public interface ESBEvent {
    ...
    public static final String ACTION_RETRIEVE_PRIORIDADES_JEFATURA = "RETRIEVE_PRIORIDADES_JEFATURA";
    public static final String ACTION_RETRIEVE_RESUMEN_PRIORIZACION = "RETRIEVE_RESUMEN_PRIORIZACION";
